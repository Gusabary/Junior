...
/* SPSR_EL1 Register aarch64 (FROM ARM-ARM C5-395 by LN) */
...
#define SCTLR_EL1_DZE               BIT(15)     /* Traps EL0 execution of DC ZVA instructions to EL1, from AArch64 state only */
